      ...
      dangerouslySetInnerHTML={{
        __html: `
          (function(c,l,a,r,i,t,y){
            ...
            t.onload=function(){
              window.__fwClarityLoaded=true;
              window.dispatchEvent(new CustomEvent("fw-clarity-status",{detail:{status:"loaded"}}));
            };
            t.onerror=function(){
              window.dispatchEvent(new CustomEvent("fw-clarity-status",{detail:{status:"blocked"}}));
            };
